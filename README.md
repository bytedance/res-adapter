...
- `[2024/03/12]` We support [gradio demo with SDXL-Lightning](https://huggingface.co/spaces/ameerazam08/Res-Adapter-GPU-Demo) in `huggingface.com` (by [@Ameer Azam](https://github.com/AMEERAZAM08))
